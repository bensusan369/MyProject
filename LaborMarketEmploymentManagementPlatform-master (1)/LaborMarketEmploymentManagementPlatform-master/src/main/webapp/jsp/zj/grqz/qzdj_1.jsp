...
<script>
	$(function(){
		$("#queryBtn").click(function(){
			location.href="${pageContext.request.contextPath}/jsp/zj/grqz/chaxun.do?bipCitizenid="+$("#bipCitizenid").val();
		});
	});
</script>
</head>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" style="display:block" id="c1" align="center" style="word-break:break-all;width:fixed">
  <tr height="200">
    <td>
        ...
        <tr>
          <td width="13%" align="center"><span class="redtxt">*</span>身份证号码：<input type="text" name="bipCitizenid" id="bipCitizenid">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="BUTTONs3" id="queryBtn" value="查询"></td >
        </tr>
        <tr>
