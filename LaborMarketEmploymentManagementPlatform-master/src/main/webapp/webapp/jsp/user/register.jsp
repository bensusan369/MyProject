...
<html>
	...
	function checkLoginName(){
		...
		var loginName = fm.userloginname.value;
		if(loginName!=""){
			var url = "${pageContext.request.contextPath}/checkuserloginname.do?userloginname=" + fm.userloginname.value+"&t="+Math.random();
				...
				if(ajax.readyState == '4'){
					if(ajax.status == '200'){
						...
						if(returnText=="SUCCESS"){
							document.getElementById("ajaxmessage").innerHTML = "<FONT color='green' size='2'>可以使用</FONT>";
						}else {
							document.getElementById("ajaxmessage").innerHTML = "<FONT color='red' size='2'>不可以使用</FONT>";
						}
					}
				}
			};
			...
			<form name="fm" action="" method="post">
				...
				<table style="margin-left:300px; width:500px;align:left;" border="0" >
					...
					<tr>
						...
						<td>
							<input id="userloginName" type="text" maxlength="32" name="userloginname"
